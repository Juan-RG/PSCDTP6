...
CLIENTE_PUBLICADOR=${CLIENTES_DIR}/Publicador
CLIENTE_BUSCADOR=${CLIENTES_DIR}/Buscador
CLIENTE_BUSCADORCOMBINADO=${CLIENTES_DIR}/BuscadorCombinado
...
SERVER_REGISTRO=${SERVIDORES_DIR}/ServidorRegistro
...
all: ${SERVER_REGISTRO} ${SERVER_LINDA} ${CLIENTE_PUBLICADOR} ${CLIENTE_BUSCADOR} ${INIT_TUPLAS} ${CLIENTE_BUSCADORCOMBINADO} ${SERVIDOR_MONITORIZACION} ${CLIENTE_CARGA}
...
clientes: ${CLIENTE_PUBLICADOR} ${CLIENTE_BUSCADOR} ${CLIENTE_BUSCADORCOMBINADO} ${INIT_TUPLAS}

clientes_pruebas: ${CLIENTE_CARGA}

servidores: ${SERVER_REGISTRO} ${SERVER_LINDA} ${SERVIDOR_MONITORIZACION}
...
clean:
	...
	$(RM) ${SERVIDOR_MONITORIZACION} ${SERVIDOR_MONITORIZACION}.o
